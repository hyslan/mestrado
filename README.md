...
Este repositório contém os materiais relacionados ao curso de Mestrado em Modelagem de Sistemas Complexos, ministrado pela Universidade de São Paulo (USP). O curso aborda diversos tópicos relacionados à modelagem, análise e simulação de sistemas complexos, utilizando ferramentas e técnicas avançadas.
